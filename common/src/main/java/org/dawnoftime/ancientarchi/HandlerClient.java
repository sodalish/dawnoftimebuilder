...
import org.dawnoftime.ancientarchi.client.gui.creative.CreativeInventoryEvents;
import org.dawnoftime.ancientarchi.client.gui.screen.DisplayerScreen;
import org.dawnoftime.ancientarchi.client.model.entity.SilkmothModel;
import org.dawnoftime.ancientarchi.client.renderer.blockentity.DisplayerBERenderer;
import org.dawnoftime.ancientarchi.client.renderer.blockentity.DryerBERenderer;
import org.dawnoftime.ancientarchi.client.renderer.entity.ChairRenderer;
import org.dawnoftime.ancientarchi.client.renderer.entity.SilkmothRenderer;
import org.dawnoftime.ancientarchi.registry.*;

@Mod.EventBusSubscriber(modid = ancientarchi.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.FORGE)
