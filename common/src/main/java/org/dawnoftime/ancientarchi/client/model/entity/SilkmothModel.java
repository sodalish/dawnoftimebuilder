package org.dawnoftime.ancientarchi.client.model.entity;
...
public class SilkmothModel<T extends SilkmothEntity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(org.dawnoftime.ancientarchi.AncientArchitecture.MOD_ID, "silkmoth"), "main");
