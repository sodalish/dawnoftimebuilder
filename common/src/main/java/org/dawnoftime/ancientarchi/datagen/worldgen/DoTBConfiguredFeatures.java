package org.dawnoftime.ancientarchi.datagen.worldgen;
...
import org.dawnoftime.ancientarchi.registry.DoTBFeaturesRegistry;
...
public class DoTBConfiguredFeatures {
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(org.dawnoftime.ancientarchi.AncientArchitecture.MOD_ID, name));
    }
