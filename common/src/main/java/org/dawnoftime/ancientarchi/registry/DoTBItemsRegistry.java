...
import org.dawnoftime.ancientarchi.block.templates.FlowerPotBlockDoTB;
import org.dawnoftime.ancientarchi.item.IHasFlowerPot;
import org.dawnoftime.ancientarchi.item.templates.ItemDoTB;
import org.dawnoftime.ancientarchi.item.templates.PotItem;
import org.dawnoftime.ancientarchi.util.DoTBFoods;

import java.util.function.Supplier;

public class DoTBItemsRegistry {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, org.dawnoftime.ancientarchi.AncientArchitecture.MOD_ID);
